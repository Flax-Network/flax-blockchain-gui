...
from flax.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "56888"
                testnet_introducer = "introducer-testnet10.flaxnetwork.org"
                testnet_dns_introducer = "dns-introducer-testnet10.flaxnetwork.org"
                bootstrap_peers = ["testnet10-node.flaxnetwork.org"]
                testnet = "testnet10"
                ...
                bootstrap_peers = ["node.flaxnetwork.org"]
                net = "mainnet"
        ...
        if change_made:
            print("Restart any running flax services for changes to take effect")
