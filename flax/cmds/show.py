...
from flax.cmds.show_funcs import show_async
...
def show_cmd(
    ...
    if connections:
        print("'flax show -c' has been renamed to 'flax peer -c' ")
    if add_connection != "":
        print("'flax show -a' has been renamed to 'flax peer -a' ")
    if remove_connection != "":
        print("'flax show -r' has been renamed to 'flax peer -r' ")
    if wallet_rpc_port is not None:
        print("'flax show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
