...
from flax.plotters.bladebit import get_bladebit_install_info, plot_bladebit, install_bladebit
from flax.plotters.chiapos import get_chiapos_install_info, plot_flax
from flax.plotters.madmax import get_madmax_install_info, plot_madmax, install_madmax
...
def install_plotter(plotter, root_path):
    if plotter == "chiapos":
        print("Flaxpos already installed. No action taken.")
        return
    elif plotter == "madmax":
        if not os.path.exists(root_path / "madmax-plotter/build/flax_plot"):
...
def call_plotters(root_path: Path, args):
    ...
    build_parser(subparsers, root_path, flax_plotter, "chiapos", "Flaxpos Plotter")
