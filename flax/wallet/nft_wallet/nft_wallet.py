...
from flax.wallet.nft_wallet.nft_off_chain import delete_off_chain_metadata, get_off_chain_metadata
...
class NFTWallet:
    ...
    async def generate_unsigned_spendbundle(
        ...
        return nft_spend_bundle, flax_tx
        ...
        for asset, amount in offer_dict.items():
            if amount < 0:
                ...
                if len(offered_coins) == 0:
                    raise ValueError(f"Did not have asset ID {asset.hex() if asset is not None else 'XFX'} to offer")
