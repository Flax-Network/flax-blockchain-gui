...
This library provides react hooks on the top of @flax/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under do hood.
...
import { useGetPublicKeysQuery } from '@flax/api-react';
...
import { store, api } from '@flax/api-react';
