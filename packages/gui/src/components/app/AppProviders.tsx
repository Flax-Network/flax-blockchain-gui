...
import WalletConnectProvider, { WalletConnectFlaxProjectId } from '../walletConnect/WalletConnectProvider';
              ...
              <ModalDialogsProvider>
                {isReady ? (
                  <Suspense fallback={<LayoutLoading />}>
                    <WalletConnectProvider projectId={WalletConnectFlaxProjectId}>
