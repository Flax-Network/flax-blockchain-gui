...
import { useGetFarmerFullNodeConnectionsQuery, useService } from '@flax-network/api-react';
import { Table, Card, FormatBytes, FormatConnectionStatus } from '@flax-network/core';
