...
import { Link, Loading, Table, Card, FormatBytes } from '@flax/core';
import { useGetFarmingInfoQuery } from '@flax/api-react';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/Flax-Network/flax-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>
