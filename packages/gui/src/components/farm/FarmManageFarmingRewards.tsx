import { fromBech32m } from '@flax-network/api';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@flax-network/api-react';
import { Button, Flex, Form, TextField, Loading } from '@flax-network/core';
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    and the 0.25XFX reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
