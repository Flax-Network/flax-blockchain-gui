import { useRefreshPlotsMutation } from '@flax-network/api-react';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@flax-network/core';
import { Plots } from '@flax-network/icons';
