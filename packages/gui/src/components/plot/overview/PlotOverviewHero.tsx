...
import { useRefreshPlotsMutation } from '@flax/api-react';
import { Grid, Typography, Divider } from '@mui/material';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@flax/core';
import { Plots } from '@flax/icons';
        ...
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              ...
              <Link
                target="_blank"
                href="https://github.com/Flax-Network/flax-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
