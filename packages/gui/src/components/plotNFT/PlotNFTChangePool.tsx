import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@flax-network/api-react';
import { Flex, State, Loading, StateTypography } from '@flax-network/core';
