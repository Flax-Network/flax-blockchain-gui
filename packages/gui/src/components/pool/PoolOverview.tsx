...
import { Flex, UnitFormat, More, Table, mojoToFlaxLocaleString, Suspender } from '@flax/core';
...
import { WalletStatus } from '@flax/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToFlaxLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }
