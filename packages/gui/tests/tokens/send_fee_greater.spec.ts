...
test('Confirm that User cannot send a TXFX fee greater then in Wallet', async () => {
  ...
  await page.locator('text=Fee *TXFX >> input[type="text"]').fill('10');
  ...
  await expect(page.locator('text=Pending Change0 TXFX')).toBeVisible();
});
