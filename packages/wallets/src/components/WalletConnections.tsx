import { Connection, ServiceConnectionName } from '@flax-network/api';
import { useGetWalletConnectionsQuery } from '@flax-network/api-react';
import { Card, FormatBytes, Loading, Table } from '@flax-network/core';
