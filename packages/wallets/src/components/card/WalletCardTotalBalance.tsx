import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@flax-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@flax-network/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for XFX, CATs, or
