...
import { Flex, Loading, useOpenDialog } from '@flax/core';
...
import { useSetCATNameMutation, useGetCatListQuery } from '@flax/api-react';
import { Offers as OffersIcon } from '@flax/icons';
