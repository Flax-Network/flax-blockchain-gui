...
import { flaxToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@flax/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = flaxToMojo(amount || '0');
      const feeMojos = flaxToMojo(fee || '0');
