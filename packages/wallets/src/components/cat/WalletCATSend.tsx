import { SyncingStatus, toBech32m } from '@flax-network/api';
import { useSpendCATMutation, useFarmBlockMutation } from '@flax-network/api-react';
import {
  AdvancedOptions,
  Button,
  EstimatedFee,
