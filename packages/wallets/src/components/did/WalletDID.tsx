...
import { AlertDialog, Card, Flex, Loading, Dropzone, mojoToFlaxLocaleString } from '@flax/core';
import {
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojoToFlaxLocaleString(props.balance)} TXFX
          </Typography>
        </Box>
      </Box>
    </Grid>
...
const CashoutCard = (props) => {
  ...
  function cashout() {
    ...
    if (puzzlehash.slice(0, 12) === 'flax_addr://') {
